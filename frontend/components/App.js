      ...
      <div id="main" className={this.state.forceTheme ? "force" : null}>
        ...
        <Panel className="mui--bg-accent-light">
          <div className="mui--text-subhead mui--text-light">
            The test network is reset quarterly. Please see our <a href="https://www.stellar.org/developers/guides/concepts/test-net.html#best-practices-for-using-testnet">testnet best practices</a> for more information.
          </div>
        </Panel>
