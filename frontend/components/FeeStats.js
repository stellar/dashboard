...
export default class FeeStats extends React.Component {
  constructor(props) {
    ...
    this.nameMap = [
      ...
      { id: "fee_charged.max", name: "Max Accepted Fee" },
      { id: "fee_charged.min", name: "Min Accepted Fee" },
      { id: "fee_charged.mode", name: "Mode Accepted Fee" },
      { id: "fee_charged.p10", name: "10th Percentile Accepted Fee" },
      { id: "fee_charged.p20", name: "20th Percentile Accepted Fee" },
      { id: "fee_charged.p30", name: "30th Percentile Accepted Fee" },
      { id: "fee_charged.p40", name: "40th Percentile Accepted Fee" },
      { id: "fee_charged.p50", name: "50th Percentile Accepted Fee" },
      { id: "fee_charged.p60", name: "60th Percentile Accepted Fee" },
      { id: "fee_charged.p70", name: "70th Percentile Accepted Fee" },
      { id: "fee_charged.p80", name: "80th Percentile Accepted Fee" },
      { id: "fee_charged.p90", name: "90th Percentile Accepted Fee" },
      { id: "fee_charged.p95", name: "95th Percentile Accepted Fee" },
      { id: "fee_charged.p99", name: "99th Percentile Accepted Fee" },
    ];
  }
